...
## sql
[Задача 1](sql/duplicates): оставить только дубликаты  
[Задача 2](sql/statistics): получить статистику  
...
[Задача 5](sql/personal-account): данные по лицевому счету  
[Задача 6](sql/duplicates2): удалить дубликаты email  
...
[Задача 5](live-coding/transaction-validation-mapping): реализовать сервис для пакетного сохранения организаций с валидацией данных и маппингом в сущности БД  
